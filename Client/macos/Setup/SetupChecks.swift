...
// each music app whether it's running and whether SonyNotch may control it.
final class SetupChecks: ObservableObject {
    ...
    // macOS never asks again about a refused permission: forget SonyNotch's answers, then ask. tccutil can reset
